...
cbar.ax.set_ylabel('LAMS Counts', size=24)
cbar.ax.tick_params(labelsize=20)
ax1.set_xlabel('Axial Length (cm)', size=24)
ax1.set_ylabel('Z Location (cm)', size=24)
...
pp.pplot(x, y, fmt='-', xlabel='Z Location (mm)', ylabel='Axial Averaged Counts')
