...
#species, dens, temp, charge, coefficent[dens,temp,charge]
    ...
    def __init__(self,filename,debug=False):
        ...
        z1=[]
        date=[]
        for z in range(self.izmax):
            header=fp.readline().split()
            if debug:
                print "header",z,":",header
        ...
        if debug:
            print "recombined metastable indices:",self.igrd
            print "parent metastable indices:",self.iprt
            print "ion charges:",self.z1
            print "dates:",self.date
            print self.comment
