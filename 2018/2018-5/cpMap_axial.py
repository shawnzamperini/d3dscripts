...
df.columns = ['Axial Location [mm]','Poloidal Location [mm]','Z_value']
df['Z_value'] = pd.to_numeric(df['Z_value'])
pivotted= df.pivot('Poloidal Location [mm]','Axial Location [mm]','Z_value')
ax=sns.heatmap(pivotted,cmap=cm.jet,cbar_kws={'label': 'Total W Intensity'}) #vmax=###### for cbar limit
ax.invert_yaxis()
