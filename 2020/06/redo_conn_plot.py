...
ax2.errorbar(a2_x, a2_y, xerr=a2_x_err, yerr=a2_y_err, fmt='k.', ms=10, capsize=3, capthick=1, elinewidth=1, ecolor='k')
ax2.errorbar(a2_x_otf, a2_y_otf, xerr=a2_x_err_otf, yerr=a2_y_err_otf, fmt='r.', ms=10, capsize=3, capthick=1, elinewidth=1, ecolor='k')
plt.yscale("log")
ax1.set_xlim([4, 14])
ax1.set_zorder(10)
ax2.set_zorder(10)
