...
ax.plot(rbbbs, zbbbs, color="k")
ax.plot(leg1_r, leg1_z, color="k")
ax.plot(leg2_r, leg2_z, color="k")
...
ax.annotate("OTF", (2.327, -0.215), xytext=(2.419, -0.30),
  arrowprops=dict(facecolor="black", arrowstyle="-"), fontsize=fontsize)
...
ax.text(2.178, -0.295, "CP", fontsize=fontsize)
