...
class BlobbyFarSOL():
    ...
    def load_rcp_profiles(self, path, start_idx=None, end_idx=None, shift=0.0, timult=1.0):
    ...
    def load_rcp_blobs(self, path, shift=0.0, min_npeaks=0, timult=1.0, vr_time_avg_mult=1.0):
        ...
        self.blob_vr_time_avg = blob["vr (m/s)"].values * blob["Tblob (1e-6 s)"].values * 1e-6 * blob["Npeaks"].values / timestep * vr_time_avg_mult
        self.blob_vr = blob["vr (m/s)"].values
        self.blob_r = blob["R (cm)"].values + shift
        self.blob_te = blob["Te (eV)"].values
    ...
    def solve_simple_m(self, window_size=3.0, showplot=True, mach_mult=1.0):
        """
        ...
        # Interpolate the connection lengths onto the RCP domain.
        ...
        # Do a running window of lambda_ne at each location. TODO: Change this to a window in space, not points.
        ...
        for i in range(0, len(self.rcp_r)):
            ...
            # elif len(self.rcp_r) - i <= int(window_size / 2):
            #     window[-window_size:] = True
            # else:
        ...
        for i in range(0, len(self.blob_r)):
            ...
            # Derived using the momentum equation.
    ...
    def plot_results(self, summary_range=[None, None], mach_mult=1.0):
        ...
        if self.shot in [190440, 190442, 190484, 190485, 190486]:
            ...
            ax1.plot(f_rho(self.blob_r[blob_mask]), self.neut_dens2[blob_mask], label="RCP-Derived", color="tab:cyan", lw=3)
            ax1.set_yscale("log")
            ax1.set_ylim([1e14, 1e18])
            ax1.set_xlim([0.99, 1.08])
            ...
            ion_gyrorad = np.sqrt(2 * 2.014 * 1.66e-27 * elec * self.blob_te[blob_mask]) / (elec * self.blob_b[blob_mask])
            norm_coll = nu_ei * f_conn_otf(self.blob_r[blob_mask]) / (elec_gyrofreq * ion_gyrorad)
            fig, ax = plt.subplots(figsize=(5, 4))
            ax.plot(f_rho(self.blob_r[blob_mask]), norm_coll)
...
def main(shot, plunge, showplot=True, min_npeaks=5):
    ...
    if shot == 190440:
        shift = 0
        if plunge == 1:
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/MP190440_1.tab", 12, 3)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190440_1.tab", min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/MP190440_2.tab", 0, 3)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190440_2.tab", min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
        ...
        shift = 0
        if plunge == 1:
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/MP190442_1.tab", 6, 7)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190442_1.tab", min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/MP190442_2.tab", 6, 7)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190442_2.tab", min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
        ...
        if plunge == 1:
            ...
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190484_1.tab", min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/MP190484_2.tab", 20, 2, shift=1.5)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190484_2.tab", min_npeaks=min_npeaks, shift=1.5, vr_time_avg_mult=vr_time_avg_mult)
        ...
        shift = 0
        if plunge == 1:
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/MP190485_1.tab", 12, 9, shift=1.0)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190485_1.tab", min_npeaks=min_npeaks, shift=1.0, vr_time_avg_mult=vr_time_avg_mult)
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/MP190485_2.tab", 6, 3, shift=-1.0)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190485_2.tab", min_npeaks=min_npeaks, shift=-1.0, vr_time_avg_mult=vr_time_avg_mult)
        ...
        shift = 0
        if plunge == 1:
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/MP190486_1.tab", 10, 2, shift=1.0)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190486_1.tab", min_npeaks=min_npeaks, shift=1.0, vr_time_avg_mult=vr_time_avg_mult)
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/MP190486_2.tab", 8, 1, shift=-0.5)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/2022-36-03/CA_190486_2.tab", min_npeaks=min_npeaks, shift=-0.5, vr_time_avg_mult=vr_time_avg_mult)
        ...
        shift = 0
        if plunge == 1:
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP184267_1.tab", 5, 2)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_184267_1.tab", min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP184267_2.tab", 10, 2)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_184267_2.tab", min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
        ...
        shift = 0
        if plunge == 1:
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP167193_1.tab", 27, 18)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_167193_1.tab", min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
            bfs.load_mafot("/Users/zamperini/Documents/d3d_work/mafot_files/167193/lam_rcp2000_conn_-1.dat",  # Took care of this
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP167193_2.tab", 26, 9)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_167193_2.tab", min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
        ...
        shift = 0.0
        if plunge == 1:
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP167195_1.tab", 1, 6, shift)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_167195_1.tab", shift, min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
            bfs.load_mafot("/Users/zamperini/Documents/d3d_work/mafot_files/167195/lam_rcp2000_conn_-1.dat",  # Took care of this
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP167195_2.tab", 7, 5, shift=-0.5)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_167195_2.tab", shift=-0.5, min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
        ...
        shift = 0
        if plunge == 1:
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP184527_1.tab", 12, 5)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_184527_1.tab", shift, min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP184527_2.tab", 14, 3)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_184527_2.tab", shift, min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
        ...
        if plunge == 1:  # This one is rough.
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP187111_1.tab", 5, 3, shift=shift)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_187111_1.tab", shift, min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
            ...
            bfs.load_rcp_profiles("/Users/zamperini/My Drive/Research/Data/rcp_data/MP187111_2.tab", shift=shift)
            bfs.load_rcp_blobs("/Users/zamperini/My Drive/Research/Data/rcp_data/blob_analyzed/CA_187111_2.tab", shift, min_npeaks=min_npeaks, vr_time_avg_mult=vr_time_avg_mult)
    ...
    bfs.solve_simple_m(showplot=showplot, window_size=window_size, mach_mult=mach_mult)
    if showplot:
        if shot in [187111]:
            pass
        else:
...
def main_all(smooth_window=None):
    ...
    plot_opt = 2
    plot_data = "myra"   # category, lambda_ne, neut_dens, vr or myra.
    ...
    for shot in shots:
        for plunge in [1, 2]:
            ...
            # For this plot we probably want to apply the connection mask as well.
                ...
                # Interested in plotting the needed neutral density against the difference in the predicted lambda_ne and measured.
    ...
    if plot_opt == 2:
        if plot_data == "vr":
            ax1.plot([0, 500], [0, 500], color="k", linestyle="--")
            sc = ax1.scatter(opt2x, opt2y, c=opt2c, cmap="inferno", vmin=0, vmax=15, zorder=15, marker="^", edgecolors="k", s=75)
            cbar = fig.colorbar(sc, ax=ax1)
            ...
            ax1.plot([0, 500], [0, 500], color="k", linestyle="--")
            sc = mscatter(opt2x, opt2y, ax=ax1, m=opt2m, c=opt2c, cmap="inferno", zorder=15, marker="^", edgecolors="k", s=75)
