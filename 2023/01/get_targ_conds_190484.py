...
# Load the LP data.
xlpath = "/Users/zamperini/Documents/d3d_work/divimp_files/190484/lp_190484.xlsx"
xl = pd.read_excel(xlpath, sheet_name="lp")[["fit_psin_shift", "fit_te", "fit_jsat"]].dropna()
lp_psin = xl["fit_psin_shift"].values
...
ncpath = "/Users/zamperini/Documents/d3d_work/divimp_files/190484/d3d_extgridtest.nc"
