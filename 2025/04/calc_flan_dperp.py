...
def load(path, xmin=None, xmax=None, spline_fit=False, vr_s=0, nz_s=0):
	...
	vY = fp.nc["imp_vY"][fstart:fend+1, :, :, zidx].data
	...
	eZ = fp.nc["elec_Z"][fstart:fend+1, :, :, zidx].data
	bX = fp.nc["bmag_X"][fstart:fend+1, :, :, zidx].data
	bY = fp.nc["bmag_Y"][fstart:fend+1, :, :, zidx].data
	bZ = fp.nc["bmag_Z"][fstart:fend+1, :, :, zidx].data
...
xmin = 2.31
xmax = 2.349
#path = "/home/zamp/flandir/sh_outward_v1_coll/sh_outward_v1_coll.nc"
#path = "/home/zamp/flandir/sh_outward_v2_coll/sh_outward_v2_coll.nc"
...
s_coll_x, s_coll_vx, s_coll_nz, s_coll_dr, coll_gy, ex, ey, d, eZ_fluc, \
	coll_vx_2d = load(path, xmin, xmax, True, 1e8, 1e-8)
#path = "/home/zamp/flandir/sh_outward_v1/sh_outward_v1.nc"
path = "/home/zamp/flandir/sh_outward_v4_nocoll/sh_outward_v4_nocoll.nc"
no_x, no_vx, no_nz, no_dr, no_gy, ex, ey, d, eZ_fluc, no_vx_2d = load(path, xmin, xmax)
s_no_x, s_no_vx, s_no_nz, s_no_dr, no_gy, ex, ey, d, eZ_fluc, no_vx_2d = load(path, xmin, xmax, True, 1e8, 1e-12)
...
ax2.set_ylabel(r"$\mathdefault{n_W\ (m^{-3})}$", fontsize=fontsize)
ax2.set_yscale("log")
