...
plt.errorbar(x=pA2U_loc[:-1], y=pA2U_areal[:-1], yerr=pA2U_arealerr[:-1], capsize=3, label="AU2")
plt.errorbar(x=pA2D_loc[:-1], y=pA2D_areal[:-1], yerr=pA2D_arealerr[:-1], capsize=3, label="AD2")
